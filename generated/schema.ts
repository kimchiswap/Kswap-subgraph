...
export class KswapFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save KswapFactory entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save KswapFactory entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("KswapFactory", id.toString(), this);
  }

  static load(id: string): KswapFactory | null {
    return store.get("KswapFactory", id) as KswapFactory | null;
  }
...
export class KswapDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save KswapDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save KswapDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("KswapDayData", id.toString(), this);
  }

  static load(id: string): KswapDayData | null {
    return store.get("KswapDayData", id) as KswapDayData | null;
  }
